...
public class Menu{
	...
	public Menu() {
		...
		zutatListe[5][0] = new Kaese(61, "Sandwich-Kaese ", 0.39f, true, true, 80, "Kuhmilch");
		zutatListe[5][1] = new Kaese(62, "Gouda ", 0.59f, false, true, 140, "Kuhmilch");
		zutatListe[5][2] = new Kaese(63, "Salakis ", 0.75f, false, true, 8, "Schafsmilch");
		zutatListe[5][3] = new Kaese(64, "Landana Rosso ", 0.95f, false, true, 8, "Ziegenmilch");
